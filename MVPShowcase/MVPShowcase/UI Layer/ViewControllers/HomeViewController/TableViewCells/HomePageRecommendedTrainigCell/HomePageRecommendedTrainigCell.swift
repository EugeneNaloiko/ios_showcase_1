//
//  HomePageRecommendedTrainigCell.swift
//
...
final class HomePageRecommendedTrainigCell: UITableViewCell {
    ...
    private func registerCollectionViewCells() {
        collectionView?.register(RecommendedTrainigCollectionViewCell.self, forCellWithReuseIdentifier: RecommendedTrainigCollectionViewCell.reuseIdentifier)
    }
...
extension HomePageRecommendedTrainigCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RecommendedTrainigCollectionViewCell.reuseIdentifier, for: indexPath) as? RecommendedTrainigCollectionViewCell else { return UICollectionViewCell() }
