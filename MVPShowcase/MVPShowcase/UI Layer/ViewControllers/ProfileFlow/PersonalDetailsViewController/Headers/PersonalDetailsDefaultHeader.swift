//
//  PersonalDetailsDefaultHeader.swift
//
...
final class PersonalDetailsDefaultHeader: UITableViewHeaderFooterView {
    ...
    private var lblTitle: UILabel = {
        ...
        lbl.font = UIFont.sfProFont(.medium, size: 12)
        lbl.numberOfLines = 0
    ...
    private func prepareUI() {
        self.contentView.backgroundColor = .tfWhiteSix
    }
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.lblTitle.trailingAnchor.constraint(equalTo: self.contentView.trailingAnchor, constant: -16),
